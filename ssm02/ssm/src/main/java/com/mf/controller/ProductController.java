...
public class ProductController {
    ...
    public String getAllProduct(String name, Integer currentPage, Integer sortId, HttpServletRequest request) {
        ...
        pages.setTotalCount(productService.getProductCount(name,sortId));
        pages.setCurrentPage(currentPage);
        List<Product> productList = productService.getAllProduct(name, sortId, currentPage, pages.getPageSize());
    ...
    public String getAllProductAdmin(String name, Integer currentPage, Integer sortId, HttpServletRequest request) {
    ...
    public String updateProductStock(Integer num,Integer pid){
        productService.updateProductStock(pid,num);
        return "redirect:/product/getAllProductAdmin";
    }
}
