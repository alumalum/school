...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> getAllProduct(String name, Integer sortId, Integer currentPage, Integer pageSize) {
        return productMapper.getAllProduct(name, sortId, (currentPage - 1) * pageSize, pageSize);
    }

    @Override
    public Integer getProductCount(String pname,Integer sortId) {
        return productMapper.getProductCount(pname,sortId);
    }
    ...
    public void updateProductStock(Integer pid, Integer stock) {
        Integer num = stock + productMapper.getProductById(pid).getStock();
        productMapper.updateProductStock(pid,num);
    }
}
