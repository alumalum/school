...
<div class="w">
    <div class="main">
        <h1 style="text-align: center">我的订单列表</h1>
        <div class="tableMain">
                ...
                <c:forEach items="${ordersList}" var="orders">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${orders.state == '已发货'}">
                                <a href="/orders/updateOrdersState?oid=${orders.oid}&id=2">退货</a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
        ...
        <div class="page">
			<span class="page_num">
                <a href="/orders/getOrders?currentPage=1">首页</a>
				<a href="/orders/getOrders?currentPage=${pages.getPrePage()}"
                   class="pn_prev">&lt;&lt;上一页 </a>
                <c:forEach items="${pages.getPageNum()}" var="num">
                    <a href="/orders/getOrders?currentPage=${num}">[${num}]</a>
                </c:forEach>
				<a href="/orders/getOrders?currentPage=${pages.getNextPage()}"
                   class="pn_next">下一页&gt;&gt;</a>
                <a href="/orders/getOrders?currentPage=${pages.getTotalPage()}">尾页</a>
			</span>
        </div>
    </div>
    <div class="footer">
