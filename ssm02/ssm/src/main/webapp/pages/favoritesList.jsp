    ...
    <div class="main">
        ...
        <div>
            <table border="1px" cellpadding="0" cellspacing="0">
                ...
                <c:forEach items="${favoritesList}" var="favorites" varStatus="i">
                    <tr <c:if test="${i.index%2 == 0}">
                        bgcolor="#a9a9a9"
                    </c:if>>
                        <td>${i.count}</td>
                        <td><img src="/uploda/${favorites.product.fileName}" style="height: 100px;width: 100px"></td>
                        <td>${favorites.product.pname}</td>
                        <td>${favorites.product.price}</td>
                        <td>
                            <a href="/favorites/deleteFavorites?pid=${favorites.pid}">删除收藏</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
