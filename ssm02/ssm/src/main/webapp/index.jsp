        ...
        <div class="dropdown fl">
            ...
            <div class="dd">
                <c:forEach items="${sortList}" var="sort">
                    <li class="menu_item"><a href="/product/getAllProduct?sortId=${sort.id}">${sort.name}</a><i></i>
                    </li>
                </c:forEach>
            </div>
        </div>
...
<div class="w">
    <div class="main">
        <div class="focus fl">
            ...
            <ul>
                <li>
                    <a href="#"><img src="uploda/focus.jpg" alt=""></a>
                </li>
                <li>
                    <a href="#"><img src="uploda/focus1.jpg" alt=""></a>
                </li>
                <li>
                    <a href="#"><img src="uploda/focus2.jpg" alt=""></a>
                </li>
                <li>
                    <a href="#"><img src="uploda/focus3.jpg" alt=""></a>
                </li>
            </ul>
            <ol class="circle">
            </ol>
